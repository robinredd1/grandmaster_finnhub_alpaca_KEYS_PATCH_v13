...
BOLD_MONEY_BALANCES = True     # bold the money balances only
COLOR_DAY_PNL       = True     # keep color just for dayPnL (green/red). Set False to disable.
COLOR_OTHER_LOGS    = False    # no colors in TOP/ENTRY/etc so balances stand out
